 ...
 if(moyenne_generale < 5){
     alert("Ta moyenne générale de " +moyenne_generale+ " indique que tu es en grande difficulté. Il te faudra travailler bien plus remonter ton niveau global. L' équipe enseignante est prete a t' aider pour atteindre cet objectif");
 } else if(moyenne_generale >= 5 && moyenne_generale < 10){
     alert("Ta moyenne générale de " +moyenne+ " indique que tu es en difficulté. Tu dois fournir un effeort supplémentaire par rapport au trimestre dernier. L' équipe enseignante est prete a t' aider pour atteindre cet objectif");
