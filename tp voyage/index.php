...
<header class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-item nav-link" href="#">Reserver</a>
            <a class="nav-item nav-link" href="#">Destinations et Escales</a>
            <a class="nav-item nav-link" href="#">Les + de TONTON & Fils</a>
            <a class="nav-item nav-link" href="#">Aide et Contact</a>
            <a class="nav-item nav-link" href="#">Offres d' emplois</a>
            <a class="nav-item nav-link" href="#">Mes billets</a>
            </div>
        </div>
